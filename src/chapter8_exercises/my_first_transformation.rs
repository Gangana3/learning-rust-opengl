...
const FIRST_TRANSFORMATION_SHADER_VERTEX: &str = include_str!("../shaders/vertex/first_transformation_shader.vert");
const FIRST_TRANSFORMATION_SHADER_FRAGMENT: &str = include_str!("../shaders/fragment/first_transformation_shader.frag");
...
pub fn create_transformation() -> glm::Mat4 {
...
pub fn main(on_loop_start: impl Fn(), on_loop_end: impl Fn(), i: i32) {
    unsafe {
        ...
        let shader_program = ShaderProgram::from_source(
            FIRST_TRANSFORMATION_SHADER_VERTEX,
            FIRST_TRANSFORMATION_SHADER_FRAGMENT,
        );
        ...
        // Transformation matrix to send to the vertex shader.
        ...
        loop {
            ...
            shader_program.set_mat4("transform", transformation.data.as_slice());
